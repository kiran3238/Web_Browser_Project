...
import javafx.application.Application; //for JavaFX application
import javafx.stage.Stage; //for window management
import javafx.stage.Screen; //for screen properties
import javafx.geometry.Rectangle2D; //for screen geometry
import java.util.ArrayList; //for managing a list of open browser windows
/**
